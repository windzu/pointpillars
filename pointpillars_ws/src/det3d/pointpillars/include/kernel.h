...
const int PILLARS_PER_BLOCK = 64;  // one thread deals with one pillar and a
                                   // block has PILLARS_PER_BLOCK threads
const int PILLAR_FEATURE_SIZE =
    64;  // feature count for one pillar depands on "params.h"
